  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown:    "text-sm font-medium bg-background border border-input rounded-md px-2 py-1 cursor-pointer focus:outline-none focus:ring-1 focus:ring-ring hover:bg-accent",
        ...
        outside:      "day-outside text-muted-foreground aria-selected:bg-primary/20 aria-selected:text-primary",
